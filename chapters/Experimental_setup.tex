...
\fbox{\includegraphics[width=\hsize]{figures/acc_complex.png}}
...
\label{fig:LHC_Plan}
\fbox{\includegraphics[width=\hsize]{figures/LHC_plan.jpg}}
...
\fbox{\includegraphics[width=\hsize]{figures/cms_diagram.png}}
...
For the physics analysis, the momentum is one key variables of the particle as normally the theory are described in momentum space ($p_x, p_y, p_z$). The detector measures the momentum in terms of the transverse momentum ($pT$), pseudorapidity ($\eta$), and the a azimuthal angle ($\phi$). The $pT$ is defined as:
\begin{equation}
    p_T = p_x + p_y,
\end{equation}
...
\fbox{\includegraphics[width=\hsize]{figures/tracker_detector.png}}
...
\fbox{\includegraphics[width=\hsize]{figures/pixel_layout.png}}
...
\fbox{\includegraphics[width=\hsize]{figures/HCAL_view.png}}
\legend{Longitudinal view CMS hadronic calorimeter with the position of its regions: HCAL Barrel (HB), Outer Calorimeter (HO), HCAL Endcaps (HE) and Forward Calorimeters (HF).}
\source{\cite{CMS:2008xjf}}
\end{figure}
...
\label{fig:cms_muon}
\fbox{\includegraphics[width=\hsize]{figures/muon_system.png}}
...
\label{fig:pf_cms}
\fbox{\includegraphics[width=\hsize]{figures/pf_cms.png}}
