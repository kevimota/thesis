...
\begin{table}[!htbp]{15cm}
  ...
  \begin{tabular}{ c | c | c | c | c }
    ...
    \multirow[c]{2}{*}{2018} & HLT\_Dimuon24       & \multirow[c]{2}{*}{$>13.9$} & \multirow[c]{2}{*}{59.82} & \multirow[c]{2}{*}{2.5 \%} \\
                             & \_Upsilon\_noCorrL1 &                             &                           &                            \\ \hline
  \end{tabular}
  \legend{Triggers used in this study in each year of data taking. The luminosity uncertainty for each year was taken from Refs. \cite{CMS-PAS-LUM-17-001, CMS-PAS-LUM-17-004, CMS-PAS-LUM-18-002}}
  \label{tab:triggers}
\end{table}
...
Table \ref{tab:DPS_xsec} presents the fiducial cross section for each data sample and $\Upsilon$ state. The values are compatible with each other so that they can be combined.
...
Finally, to calculate the combined cross section for each $\Upsilon$ state, the fit was performed using the data from all the samples. The values are:
\begin{equation}
  \begin{split}
    \sigma_{Y(1S)D^{*\pm}} &= 515^{+108}_{-150} \; \text{pb},\\
    \sigma_{Y(2S)D^{*\pm}} &= 254^{+53}_{-74} \; \text{pb},\\
    \sigma_{Y(3S)D^{*\pm}} &= 160^{+34}_{-47} \; \text{pb},
  \end{split}
\end{equation}
...
A summary of the systematic uncertainties for each of the calculated cross sections are given in Tabs. \ref{tab:systematics1S}, \ref{tab:systematics2S} and \ref{tab:systematics3S}.

\begin{table}[!htbp]{15cm}
  \caption{Systematic Uncertainties for $\Upsilon(1S) + $D$^{*}$ cross section measurement.}
  \begin{tabular}{ c | c | c | c | c }
    \hline
    \multirow[c]{2}{*}{Source of uncertainty} & \multicolumn{4}{ c }{Sample} \bigstrut                               \\\cline{2-5}
                                              & 2016APV                                & 2016    & 2017    & 2018    \\ \hline
    Integrated Luminosity                     & 2.5 \%                                 & 2.5 \%  & 2.3 \%  & 2.5 \%  \\ \hline
    $\Upsilon(1S)$ Branching fraction         & \multicolumn{4}{c}{2.0 \%}                                           \\ \hline
    D$^*$ Branching fraction                  & \multicolumn{4}{c}{1.1 \%}                                           \\ \hline
...
\begin{table}[!htbp]{15cm}
  ...
  \begin{tabular}{ c | c | c | c | c }
    ...
    \multirow[c]{2}{*}{Source of uncertainty} & \multicolumn{4}{ c }{Sample} \bigstrut                               \\\cline{2-5}
                                              & 2016APV                                & 2016    & 2017    & 2018    \\ \hline
    Integrated Luminosity                     & 2.5 \%                                 & 2.5 \%  & 2.3 \%  & 2.5 \%  \\ \hline
    $\Upsilon(2S)$ Branching fraction         & \multicolumn{4}{c}{2.0 \%}                                           \\ \hline
    D$^*$ Branching fraction                  & \multicolumn{4}{c}{1.1 \%}                                           \\ \hline
    Determination of the yields               & 7.6 \%                                 & 8.8 \%  & 4.9 \%  & 6.7 \%  \\ \hline
...
\begin{table}[!htbp]{15cm}
  ...
  \begin{tabular}{ c | c | c | c | c }
    ...
    \multirow[c]{2}{*}{Source of uncertainty} & \multicolumn{4}{ c }{Sample} \bigstrut                               \\\cline{2-5}
                                              & 2016APV                                & 2016    & 2017    & 2018    \\ \hline
    Integrated Luminosity                     & 2.5 \%                                 & 2.5 \%  & 2.3 \%  & 2.5 \%  \\ \hline
    $\Upsilon(3S)$ Branching fraction         & \multicolumn{4}{c}{2.0 \%}                                           \\ \hline
    D$^*$ Branching fraction                  & \multicolumn{4}{c}{1.1 \%}                                           \\ \hline
    Determination of the yields               & 7.6 \%                                 & 8.8 \%  & 4.9 \%  & 6.7 \%  \\ \hline
...
\begin{equation}
  \sigma_{eff} > 8.2^{+1.5}_{-2.0} \text{(stat)} \; \text{mb}.
\end{equation}
