...
\begin{table}[!htbp]{15cm}
  ...
  \begin{tabular}{ l | l }
    ...
    longitudinal impact parameter of $K$ and $\pi$ & \multirow[c]{2}{*}{0.5/$\sin{\theta}$} \\
    from PV & \\ \hline
...
\begin{table}[!htbp]{15cm}
  ...
  \begin{tabular}{ c | c }
    ...
    \hline
    N$_{evt}$                    & 6570 \\ \hline
    N$_{sig} \Upsilon(1S)$       & $453 \pm 52$ \\ \hline
    N$_{sig} \Upsilon(2S)$       & $187 \pm 24$ \\ \hline
    N$_{sig} \Upsilon(3S)$       & $131 \pm 18$ \\ \hline
    m$_{scale}$                  & $0.9981 \pm 0.0004$ \\ \hline
    $\Delta$m mean               & $145.38 \pm 0.04$ MeV \\ \hline
    $\chi^2 \Upsilon$ projection & 1.58 \\ \hline
    $\chi^2 D^{*\pm}$ projection & 1.58 \\ \hline
  \end{tabular}
...
\begin{table}[!htbp]{15cm}
  ...
  \begin{tabular}{ c | c }
    ...
    \hline
    N$_{evt}$                    & 6190 \\ \hline
    N$_{sig} \Upsilon(1S)$       & $466 \pm 61$ \\ \hline
    N$_{sig} \Upsilon(2S)$       & $180 \pm 27$ \\ \hline
    N$_{sig} \Upsilon(3S)$       & $113 \pm 19$ \\ \hline
    m$_{scale}$                  & $0.9980 \pm 0.0005$ \\ \hline
    $\Delta$m mean               & $145.42 \pm 0.01$ MeV \\ \hline
    $\chi^2 \Upsilon$ projection & 1.13 \\ \hline
    $\chi^2 D^{*\pm}$ projection & 1.57 \\ \hline
  \end{tabular}
...
\begin{table}[!htbp]{15cm}
  ...
  \begin{tabular}{ c | c }
    ...
    \hline
    N$_{evt}$                    & 8153 \\ \hline
    N$_{sig} \Upsilon(1S)$       & $582 \pm 47$ \\ \hline
    N$_{sig} \Upsilon(2S)$       & $231 \pm 21$ \\ \hline
    N$_{sig} \Upsilon(3S)$       & $152 \pm 15$ \\ \hline
    m$_{scale}$                  & $0.9982 \pm 0.0003$ \\ \hline
    $\Delta$m mean               & $145.36 \pm 0.05$ MeV \\ \hline
    $\chi^2 \Upsilon$ projection & 1.05 \\ \hline
    $\chi^2 D^{*\pm}$ projection & 1.22 \\ \hline
  \end{tabular}
...
\begin{table}[!htbp]{15cm}
  ...
  \begin{tabular}{ c | c }
    ...
    \hline 
    N$_{evt}$                    & 16281 \\ \hline
    N$_{sig} \Upsilon(1S)$       & $1184 \pm 70$ \\ \hline
    N$_{sig} \Upsilon(2S)$       & $473 \pm 31$ \\ \hline
    ...
    $\chi^2 D^{*\pm}$ projection & 1.11 \\ \hline
  \end{tabular}
...
\begin{table}[!htbp]{15cm}
  ...
  \begin{tabular}{ l | c }
    ...
    2016APV & $7.50^{+0.96}_{-1.57}$ \\ \hline
    2016    & $9.38^{+1.14}_{-2.64}$ \\ \hline
    2017    & $6.89^{+1.18}_{-1.67}$ \\ \hline
    2018    & $4.49^{+1.53}_{-1.73}$ \\ \hline
  \end{tabular}
...
\begin{equation}
  \sigma = \frac{N_{\Upsilon(nS) D^*}}{L\cdot eff \cdot BR(\Upsilon(nS))BR(D^*)},
\end{equation}
...
Table \ref{tab:cross_section} presents the fiducial cross section for each data sample and $\Upsilon$ state. The values are compatible with each other so that the can be combined.

\begin{table}[!htbp]{15cm}
  \caption{$\Upsilon(nS)$ + D$^{*}$ fiducial cross section per data sample.}
  \begin{tabular}{ l | l | c }
    \hline
    $\Upsilon$ state & Sample & Cross section (pb) \\ \hline
    \multirow[c]{4}{*}{$\Upsilon(1S)$ + D$^{*\pm}$} 
    & 2016APV & $4.7^{+0.8}_{-1.1}$ \bigstrut\\\cline{2-3} 
    & 2016    & $4.5^{+0.8}_{-1.4}$ \bigstrut\\\cline{2-3} 
    & 2017    & $4.7^{+0.9}_{-1.2}$ \bigstrut\\\cline{2-3} 
    & 2018    & $6.7^{+2.3}_{-2.6}$ \\ \hline
    \multirow[c]{4}{*}{$\Upsilon(2S)$ + D$^{*\pm}$} 
    & 2016APV & $2.5^{+0.5}_{-0.6}$ \bigstrut\\\cline{2-3} 
    & 2016    & $2.2^{+0.4}_{-0.7}$ \bigstrut\\\cline{2-3} 
    & 2017    & $2.4^{+0.5}_{-0.6}$ \bigstrut\\\cline{2-3} 
    & 2018    & $3.4^{+1.2}_{-1.3}$ \\ \hline
    \multirow[c]{4}{*}{$\Upsilon(3S)$ + D$^{*\pm}$} 
    & 2016APV & $1.6^{+0.3}_{-0.4}$ \bigstrut\\\cline{2-3} 
    & 2016    & $1.2^{+0.3}_{-0.4}$ \bigstrut\\\cline{2-3} 
    & 2017    & $1.4^{+0.3}_{-0.4}$ \bigstrut\\\cline{2-3} 
    & 2018    & $2.0^{+0.7}_{-0.8}$ \\ \hline
  \end{tabular}
...
\begin{equation}
\begin{split}
  \sigma_{Y(1S)+D*} &= 5.6^{+1.2}_{-1.3} \; \text{pb},\\
  \sigma_{Y(2S)+D*} &= 2.9^{+0.6}_{-0.7} \; \text{pb},\\
  \sigma_{Y(3S)+D*} &= 1.7^{+0.3}_{-0.4} \; \text{pb},
\end{split} 
\end{equation}
