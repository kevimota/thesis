...
\begin{table}[!htbp]{15cm}
  ...
  \begin{tabular}{ l | l }
    ...
    $\mu$ pseudorapidity ($\eta_\mu$) & $|\eta| < 2.4$ \\ \hline
    $\Upsilon$ transverse momentum ($p_T^\Upsilon$) & $15 < p_T^\Upsilon < 300$ GeV \\ \hline
    $\Upsilon$ rapidity ($\eta_\Upsilon$) & $|y| < 2.5$ \\ \hline
    ...
    D$^*$ transverse momentum ($p_T^{D^*}$) & $4 < p_T^{D^*} < 100$ GeV \\ \hline
...
\begin{itemize}
  ...
  \item Loose transverse and longitudinal impact parameter cuts, dxy < 0.3 cm and dz < 20 cm w.r.t. the primary vertex.
\end{itemize}
