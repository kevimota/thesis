...
\begin{figure}[!htm]{15cm}
  ...
  \subfloat[][]{\label{subfig:dimu_mass_selection}%
    \fbox{\includegraphics[width=0.47\textwidth]{figures/data_sel/2018/DimuDstar/dimu_mass_2018.png}}}\hfill
  \subfloat[][]{\label{subfig:dstar_deltam_selection}%
    \fbox{\includegraphics[width=0.47\textwidth]{figures/data_sel/2018/DimuDstar/dstar_deltamr_2018.png}}}\\
