...
\titulo{Associated Production of $\Upsilon$ and D$^{*\pm}$ in pp collisions at $\sqrt{s} = 13$ TeV with CMS detector}
\title{Associated Production of $\Upsilon$ and D$^{*\pm}$ in pp collisions at $\sqrt{s} = 13$ TeV with CMS detector}

% se não for usar a quarta palavra chave, deixar o campo vazio: {}
\palavraschaves{Multiplo Espalhamento Partônico}
               {Cromodinâmica Quântica}
               {Compact Muon Solenoid}
               {Câmara de Placas Resistivas}

\keywords{Multiple Parton Scattering}
...
% ----------------------------------------------------------
%
\input{pre_textual/dedication}
%
% ----------------------------------------------------------
% Agradecimentos
% ----------------------------------------------------------
%
\input{pre_textual/acknowlegments}
%
% ----------------------------------------------------------
% Epigrafe (opcional)
% ----------------------------------------------------------
...
% ----------------------------------------------------------
%
\input{pre_textual/abreviation_symbols}
%
% ----------------------------------------------------------
% Sumario
% ----------------------------------------------------------
...
\input{chapters/Standard_Model_MPS}
...
%\input{pos_textual/glossario}
%XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
% Apêndices (opcionais)
%XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
\appendix % inicia os apêndices
%XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
\input{pos_textual/appendix}
%XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
% Anexos (opcionais)
%XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
%\annex % inicia os anexos
%XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
%\input{pos_textual/annex}
%/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
\end{document}
%/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/